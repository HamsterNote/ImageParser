...
var Yt = (t) => wf(Wn({}, "__esModule", { value: !0 }), t);
			...
			if (typeof r == "object") {
				...
				if (Array.isArray(r)) {
					...
					for (let m of this.outputNames) if (p.indexOf(m) !== -1) {
						let g = r[m];
						(g === null || g instanceof Ke) && (c = !0, s = !1, o[m] = g);
					}
					if (c) {
						if (typeof n == "object" && n !== null) i = n;
						else if (typeof n < "u") throw new TypeError("'options' must be an object.");
...
`));
	...
	if (r || n) {
		...
		n && (d = (a) => {
			...
			if (z(a)) return new Promise((h, f) => {
				...
				_.open("GET", a, !0), _.responseType = "arraybuffer", _.onload = () => {
	...
	var g, b, y, w, S, x, $ = console.log.bind(console), T = console.error.bind(console), I = $, E = T, A = !1, z = (a) => a.startsWith("file://");
	function v() {
	...
	var N, K, q, Q, D, W, j, Y, Z, te, ie, we = !1;
	function Te() {
		var a = ht.buffer;
	...
	function U(a) {
		throw E(a = "Aborted(" + a + ")"), A = !0, a = new WebAssembly.RuntimeError(a + ". Build with -sASSERTIONS for more info."), S?.(a), a;
	}
	function X() {
		return { a: {
			ma: Em,
	...
	var Ho = (a) => new Promise((l) => {
		a.onmessage = (_) => {
			...
			if (_ = C.Uc, C.ad && C.ad != _r()) {
				...
				Wo(It[C.Qd]);
			}) : _ === "loaded" ? (a.loaded = !0, l(a)) : C.target === "setimmediate" ? a.postMessage(C) : _ === "uncaughtException" ? a.onerror(C.error) : _ === "callHandler" ? e[C.zd](...C.args) : _ && E(`worker sent an unknown command ${_}`);
		}, a.onerror = (_) => {
	...
	function ip(a) {
		var l = new _n(a >>>= 0);
		return (v(), N)[l.Vc + 12 >>> 0] == 0 && (qo(l, !0), cr--), Ko(l, !1), lr.push(l), Fi(a);
	}
	var Ut = 0, ap = () => {
		ce(0, 0);
		var a = lr.pop();
	...
	var lp = () => {
		...
		var l = a.ed;
		throw (v(), N)[a.Vc + 13 >>> 0] == 0 && (lr.push(a), Ko(a, !0), qo(a, !1), cr++), Rn(l), Ut = l;
	};
	function cp(a, l, h) {
		var f = new _n(a >>>= 0);
	...
	var pi = (a, l, h) => {
		switch (l) {
			case 1: return h ? (f) => (v(), N)[f >>> 0] : (f) => (v(), K)[f >>> 0];
			case 2: return h ? (f) => (v(), q)[f >>> 1 >>> 0] : (f) => (v(), Q)[f >>> 1 >>> 0];
			case 4: return h ? (f) => (v(), D)[f >>> 2 >>> 0] : (f) => (v(), W)[f >>> 2 >>> 0];
	...
	function Bp(a, l) {
		(a >>>= 0) == l >>> 0 ? setTimeout(fr) : o ? postMessage({
			ad: a,
			Uc: "checkMailbox"
		}) : (a = It[a]) && a.postMessage({ Uc: "checkMailbox" });
	}
	var Cn = [];
	...
	var yt = 0, et = null, hi = 0, gr = [], An = /* @__PURE__ */ new Map(), gi = /* @__PURE__ */ new Map(), yi = /* @__PURE__ */ new Map(), Lp = 0, En = null, Wp = [], bi = (a) => function(l) {
		if (!A) {
			if (yt === 0) {
				...
				l((_ = 0) => {
					if (!A && (hi = _, h = !0, f)) {
						yt = 2, hr(() => Pa(et)), typeof MainLoop < "u" && MainLoop.yd && MainLoop.resume(), _ = !1;
						try {
							var C = function() {
								var G = (v(), D)[et + 8 >>> 2 >>> 0];
						...
						if (!et) {
							var B = En;
							B && (En = null, (_ ? B.reject : B.resolve)(C), P = !0);
						}
						if (_ && !P) throw C;
					}
				}), f = !0, h || (yt = 1, et = function() {
...
`))[0] == "Error" && f.shift(), Ci(f);
	...
	function Ei(a, l) {
		...
		for (h of Ai()) {
			var C = l + f;
			(v(), W)[a + _ >>> 2 >>> 0] = C, f += gt(h, C, Infinity) + 1, _ += 4;
		}
		return 0;
	}
	function ki(a, l) {
	...
	o || function() {
		...
		switch (h.endsWith("*") && (h = "*"), h) {
			...
			case "*":
				(v(), W)[a >>> 2 >>> 0] = l;
				break;
			default: U(`invalid type for setValue: ${h}`);
		}
		...
		switch (l.endsWith("*") && (l = "*"), l) {
			...
			case "float": return (v(), j)[a >>> 2 >>> 0];
			case "double": return (v(), Y)[a >>> 3 >>> 0];
			case "*": return (v(), W)[a >>> 2 >>> 0];
			default: U(`invalid type for getValue: ${l}`);
		}
	...
	var Bi, Mi, _r, tt, Zt, Dn, Ri, Ui, Ni, Bn, Vi, Li, ce, Qt, Wi, de, Mn, le, Gi, Rn, Hi, Fi, qi, Un, Ki, ji, Zi, Qi, Yi, Xi, Ji, ea, ta, ra, na, oa, ia, aa, sa, ua, da, la, ca, pa, ma, fa, ha, ga, ya, ba, wa, _a, va, $a, xa, Sa, Ta, Ia, Ca, Aa, Ea, ka, Pa, Oa, ct, Cm = [
		...
		930441: (a) => e.Hd(a),
		930473: (a, l, h) => {
			e.jd(Number(a), Number(l), Number(h), !0);
		},
		930536: (a, l, h) => {
			e.jd(Number(a), Number(l), Number(h));
		},
		930593: () => typeof wasmOffsetConverter < "u",
		930650: (a) => {
			e.ac("Abs", a, void 0);
		},
		930701: (a) => {
	...
	function vr() {
		if (0 < Ce) $e = vr;
			...
			0 < Ce ? $e = vr : (e.calledRun = !0, A || (re(), w?.(e)));
		}
	}
...
var ys, Xn, Tf, Le, bs, Yn, If, Cf, ws, Af, hs, _s, gs, vs, Cr = V(() => {
	...
	ys = typeof location > "u" ? void 0 : location.origin, Xn = import.meta.url > "file:" && import.meta.url < "file;", Tf = () => {
		if (Xn) return new URL(new URL("ort.bundle.min.mjs", import.meta.url).href, ys).href;
...
var Jn, eo, Mr, $s, Ef, kf, Pf, Ar, ge, vt = V(() => {
	...
	eo = !1, Mr = !1, $s = !1, Ef = () => {
		...
		let o = t.wasmPaths, i = typeof o == "string" ? o : void 0, s = o?.mjs, u = s?.href ?? s, d = o?.wasm, c = d?.href ?? d, p = t.wasmBinary, [m, g] = await vs(u, i, r > 1, !!p || !!c), b = !1, y = [];
		if (e > 0 && y.push(new Promise((w) => {
			...
			g(x).then(($) => {
				Mr = !1, eo = !0, Jn = $, w(), m && URL.revokeObjectURL(m);
			}, ($) => {
				Mr = !1, $s = !0, S($);
			});
...
var Mf, Rf, Cs, As, Lr, Uf, se, nt = V(() => {
	...
	Mf = [
		...
		let r = tr(t);
		r >= tr(Cs) && Rf(r, typeof e == "function" ? e() : e);
	}, se = (...t) => {
		As && Uf(...t);
	};
});
...
var Os, ao, zs, Nf, Ps, Vf, Ds, Hr, Fr, io, Bs, Ms = V(() => {
	...
	Os = new Map([
		...
		registerTensor(e, r, n, o) {
			let i = this.getMLContext(e), s = Ps(), u = new Hr({
				sessionId: e,
				context: i,
				tensor: r,
				dataType: n,
...
var Dt, fo, be, Pe, L, fe, ho, Bt, je, F, Zr, O, R, Gs, Qr, mo, Hs, ae = V(() => {
  ...
  fn o2i_${t}(offset: u32) -> ${g.indices} {
    ...
    ${$}
    return indices;
  }`, I = (U) => (y.offsetToIndices = !0, s < 2 ? U : `o2i_${t}(${U})`), E = [];
		if (s >= 2) for (let U = s - 1; U >= 0; U--) E.push(`${F(x, U, s)} * (indices[${U}])`);
		let A = s < 2 ? "" : `
  fn i2o_${t}(indices: ${g.indices}) -> u32 {
    return ${E.join("+")};
  }`, z = (U) => (y.indicesToOffset = !0, s < 2 ? U : `i2o_${t}(${U})`), v = (...U) => s === 0 ? "0u" : `${g.indices}(${U.map(b).join(",")})`, M = (U, X) => s < 2 ? `${U}` : `${F(U, X, s)}`, N = (U, X, Se) => s < 2 ? `${U}=${Se};` : `${F(U, X, s)}=${Se};`, K = {}, q = (U, X) => {
  ...
  fn get_${t}(${u.map((Se) => `d${Se}: u32`).join(", ")}) -> ${p} {
    return get_${t}ByIndices(${v(u.map((Se) => `d${Se}`).join(", "))});
  }`, Y = (...U) => {
			if (U.length !== s) throw new Error(`indices length must be ${s}`);
			let X = U.map(b).join(",");
			return s === 0 ? D("0u") : s === 1 ? D(X[0]) : (y.get = !0, y.getByIndices = !0, y.indicesToOffset = !0, `get_${t}(${X})`);
		}, Z = (U) => s < 2 ? D(U) : (y.getByIndices = !0, y.indicesToOffset = !0, `get_${t}ByIndices(${U})`), te = s < 2 ? "" : `
  fn set_${t}ByIndices(indices: ${g.indices}, value: ${p}) {
    ${Q(`i2o_${t}(indices)`, "value")}
  }`, ie = s < 2 ? "" : `
  fn set_${t}(${u.map((Se) => `d${Se}: u32`).join(", ")}, value: ${p}) {
    set_${t}ByIndices(${v(u.map((Se) => `d${Se}`).join(", "))}, value);
  }`;
		return {
			impl: () => {
				let U = [], X = !1;
				return y.offsetToIndices && (U.push(T), X = !0), y.indicesToOffset && (U.push(A), X = !0), y.broadcastedIndicesToOffset && (Object.values(K).forEach((Se) => U.push(Se)), X = !0), y.set && (U.push(ie), X = !0), y.setByIndices && (U.push(te), X = !0), y.get && (U.push(j), X = !0), y.getByIndices && (U.push(W), X = !0), !i && X && U.unshift(`const ${S} = ${g.indices}(${r.join(",")});`, `const ${x} = ${g.indices}(${k.computeStrides(r).join(",")});`), U.join(`
`);
			},
			type: g,
			offsetToIndices: I,
			...
			set: (...U) => {
				...
				return s === 0 ? Q("0u", X) : s === 1 ? Q(Se[0], X) : (y.set = !0, y.setByIndices = !0, y.indicesToOffset = !0, `set_${t}(${Se}, ${X})`);
			},
			setByOffset: Q,
			setByIndices: (U, X) => s < 2 ? Q(U, X) : (y.setByIndices = !0, y.indicesToOffset = !0, `set_${t}ByIndices(${U}, ${X});`),
			get: Y,
			getByOffset: D,
			getByIndices: Z,
			usage: n,
...
var Hf, Fs, Ff, qf, Kf, jf, Oe, qs, Ks, pt = V(() => {
  ...
  ${w.mainStart()}
    ...
    output[global_idx] = input[global_idx];
		...
		let { newShape: p, newPerm: m } = Kf(t.dims, o), g = k.areEqual(m, [
			2,
			3,
			1
		]), b = k.areEqual(m, [
...
`)}
		...
		t.compute(Xr(e, {
			hint: i.cacheKey,
			inputDependencies: ["rank"]
		}, [o[0]], i.noopWithEmptyAxes && i.axes.length === 0 ? ih : n, i.axes, o[0].dataType, i.keepDims, i.noopWithEmptyAxes), { inputs: [0] });
	}, ah = (t, e) => {
...
var gh, bo, yh, bh, wh, Wt, _h, wu, Jr = V(() => {
    ...
    `, yh = (t, e, r, n, o, i, s, u) => {
		...
		], b = be(t.dataType, d), y = Pe(1, d), w = ["type"];
  ...
  ${x.mainStart([
    ...
    if (sum == 0) {
      ...
      ${s ? `
		...
		let v = (M) => {
			let N = O("q", e.dataType, e.dims, S), q = [N, O("key", r.dataType, r.dims, S)];
			if (E) {
  ...
  ${M.mainStart([
    ...
    if (global_id.y < uniforms.M && global_id.x < total_sequence_length) {
      ...
      var sum: f32 = ${(() => {
		...
		], $ = m && n && k.size(n.dims) > 0, T = ["type", "type"];
		...
		let E = (A) => {
			let z = O("probs", e.dataType, e.dims), M = [z, O("v", r.dataType, r.dims)];
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
		...
		let r = [
			...
			let g = R("output_q", d[0].dataType, r), b = R("output_k", d[0].dataType, r), y = R("output_v", d[0].dataType, r), w = O("input", d[0].dataType, d[0].dims), S = O("weight", d[1].dataType, d[1].dims), x = O("bias", d[2].dataType, d[2].dims), $ = w.type.storage;
			return `
  const TILE_SIZE = ${s}u;
...
var Ih, he, Su, Tu, Iu, Cu, Au, Eu, ku, Pu, Ou, Ch, zu, Du, Bu, Mu, nr, Ru, en, Uu, Nu, Vu, Lu, Wu, Gu, Hu, Fu, qu, Ku, ju, Zu, Qu, Yu, Xu, Ju, ed, td, wo, _o, rd, nd, od, Ah, Eh, id, tn = V(() => {
	...
	Ih = (t, e, r, n, o, i, s) => {
		...
		let c = O("inputData", r, [u], 4), p = R("outputData", n, [u], 4), m = [{
			name: "vec_size",
			type: "u32"
		}];
		return s && m.push(...s), `
  ...
  ${t.mainStart()}
    ...
    ${p.setByOffset("global_idx", d)}
		...
		t.compute(he(t.inputs[0], "Clip", (o) => `clamp(${o}, vec4<${n}>(uniforms.min), vec4<${n}>(uniforms.max))`, void 0, r.cacheKey, void 0, [{
...
var Oh, zh, dt, dd, ld, cd, pd, md, fd, hd, gd, yd, bd, wd = V(() => {
	...
	Oh = (t, e, r, n, o, i, s, u, d, c, p, m) => {
		...
		let u = r.dims.map(Number), d = n.dims.map(Number), c = !k.areEqual(u, d), p = u, m = k.size(u), g = !1, b = !1, y = [c];
		if (c) {
			let w = ot.calcShape(u, d, !1);
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `, Lh = (t) => t ? "let ACached = mm_Asub[k][tileRow + innerRow];" : "let ACached = mm_Asub[tileRow + innerRow][k];", $o = (t, e, r = "f32", n, o = !1, i = 32, s = !1, u = 32, d = !1) => {
...
`;
    ...
    `;
		...
		let q = (Q) => {
			...
			Ye(e, we);
			let Te = be(te.type.tensor), re = Ze(e, te.type.value, Te), U = Wh(T, K, re, [
				W,
				Y,
				Z,
				te
...
var Gh, Cd, Ad = V(() => {
	...
	Td();
	sn();
	Gh = (t, e, r, n, o = !1, i, s = 4, u = 4, d = 4, c = "f32") => {
		let p = (N) => {
			switch (N) {
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${E}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${w ? `vec4<${te}>` : te}) {
      ...
      }`, re = [O("x", t[0].dataType, t[0].dims.length, E === 3 ? 1 : E), O("w", t[1].dataType, t[1].dims.length, Z)], U = R("result", t[0].dataType, r.length, Z);
			if (s) {
        ...
        ${w ? vo(T, $, te, void 0, !c, v) : $o(T, $, te, void 0, !c, v, !1, void 0, u)}`;
		};
		return {
			name: "Conv2DMatMul",
			shaderCache: {
...
var Hh, Ed, un, Fh, kd, qh, Pd, Od, zd = V(() => {
	...
	Hh = (t) => {
		...
		t,
		t
	] : t, un = (t, e) => e <= 1 ? t : t + (t - 1) * (e - 1), Fh = (t, e, r, n = 1) => {
		let o = un(e, n);
		...
		if (t === "VALID" && (t = 0), typeof t == "number") {
			...
			let y = (m - 1) * o + u - e, w = (g - 1) * i + d - r, S = (b - 1) * s + c - n, x = Math.floor(y / 2), $ = y - x, T = Math.floor(w / 2), I = w - T, E = Math.floor(S / 2);
			p = {
				top: T,
				bottom: I,
				left: E,
	...
	}, Pd = (t, e, r, n, o, i = !1, s = "channelsLast") => {
		let u, d, c, p, m;
		if (s === "channelsLast") [u, d, c, p, m] = t;
		else if (s === "channelsFirst") [u, m, d, c, p] = t;
		else throw new Error(`Unknown dataFormat ${s}`);
		let [g, , b, y, w] = e, [S, x, $] = Ed(r), [T, I, E] = Ed(n), A = un(b, T), z = un(y, I), v = un(w, E), { padInfo: M, outDepth: N, outHeight: K, outWidth: q } = qh(o, d, c, p, S, x, $, A, z, v), Q = i ? g * m : g, D = [
			0,
			0,
			0,
			0,
		...
		let x = ($) => {
			...
			Ye(e, T);
			let I = 1, E = be(t[0].dataType), A = O("x", t[0].dataType, t[0].dims.length, g === 3 ? 1 : g), z = O("W", t[1].dataType, t[1].dims.length, I), v = [A, z], M = R("result", t[0].dataType, r.length, I), N = "";
			if (S) {
...
var Kh, xo, jh, So, To, Rd, Zh, Qh, Io, Ud = V(() => {
	...
	Kh = (t, e, r, n, o, i) => {
		...
		let S = !0, x = t.kernelCustomData.wT ?? t.compute(Oe(e[1], xo), {
			inputs: [1],
			outputs: [r.wIsConst ? -2 : -1]
		})[0];
		...
		let n = r.format === "NHWC" ? "channelsLast" : "channelsFirst", o = So(r, e), i = r.autoPad === "NOTSET" ? r.pads : r.autoPad, s = Pd(e[0].dims, e[1].dims, r.strides, r.dilations, i, !1, n);
...
var Nd, Vd = V(() => {
	...
	Nd = (t, e, r) => {
		...
		let $ = ["rank", "rank"], T = [e.strides[0], e.strides[1]], I = [e.kernelShape[i ? 1 : 2], e.kernelShape[i ? 2 : 3]], E = [e.dilations[0], e.dilations[1]], A = [I[0] + (e.dilations[0] <= 1 ? 0 : (e.kernelShape[i ? 1 : 2] - 1) * (e.dilations[0] - 1)), I[1] + (e.dilations[1] <= 1 ? 0 : (e.kernelShape[i ? 2 : 3] - 1) * (e.dilations[1] - 1))], z = [A[0] - 1 - Math.floor((e.pads[0] + e.pads[2]) / 2), A[1] - 1 - Math.floor((e.pads[1] + e.pads[3]) / 2)], v = [
			{
				type: 12,
				data: S
			},
		...
		let M = (N) => {
			...
			], q = be(t[0].dataType), Q = i ? 1 : 2, D = i ? 2 : 3, W = i ? 3 : 1, j = O("W", t[1].dataType, t[1].dims.length, w), Y = O("Dy", t[0].dataType, t[0].dims.length, p), Z = [Y, j];
...
var Co, dn, Xd, ag, sg, Ao, Eo, Jd, ug, el, tl, rl = V(() => {
	...
	Co = "[a-zA-Z]|\\.\\.\\.", dn = "(" + Co + ")+", Xd = "^" + dn + "$", ag = "(" + dn + ",)*" + dn, sg = "^" + ag + "$", Ao = class {
		...
		let i = t.map((p) => p.length).map((p, m) => O(`input${m}`, e, p)), s = k.size(n), u = R("output", e, n.length), d = [...r.symbolToInfo.keys()].filter((p) => !r.rhs.symbolToIndices.has(p)), c = (p) => {
			...
			let I = T ? [...m, `let sum = ${i.map((E, A) => E.getByIndices(`input${A}Indices`)).join(" * ")};`] : [
				...m,
				b,
				...S,
				...w,
...
var pg, al, sl = V(() => {
	...
	pg = (t) => {
		let e = t[0].dataType, r = k.size(t[0].dims), n = k.size(t[1].dims), o = n % 4 === 0, i = (s) => {
			let u = O("x", e, [1], 4), d = O("bias", e, [1], 4), c = R("y", e, [1], 4), p = [{
...
var hg, cl, pl, ml = V(() => {
	...
	hg = (t, e, r, n, o, i, s, u, d) => {
		...
		c.push(...L(e.dims, p));
		let m = (g) => {
			let w = [O("indices_data", e.dataType, e.dims.length), R("input_slice_offsets_data", 12, 1, 1)], S = [
				{
					name: "output_size",
					type: "u32"
				},
	...
	gg = (t, e) => {
		...
		return {
			...
			shaderCache: {
				...
				inputDependencies: Array.from({ length: t.length }, (y, w) => "rank")
			},
			getRunData: () => ({
				outputs: [{
					dims: u,
...
`, Ag = (t, e, r) => (() => {
		...
		let s = R("output", t[0].dataType, i.length), u = r.type.value, c = [{
			type: 12,
			data: k.size(i)
		}, ...L(t[0].dims, n, i)], p = (m) => `
...
var Re, Og, Cl, Il, zg, ar, Al, ko = V(() => {
	...
	Re = (t, e) => t.length > e && t[e].dims.length > 0 ? t[e] : void 0, Og = (t, e) => {
		...
		if (s && k.size(s.dims) > 0) {
			T = 8;
			let z = s.dims;
			throw z.length === 1 ? z[0] === p ? T = 1 : z[0] === 3 * p + 2 && (T = 3) : z.length === 2 && z[0] === p && z[1] === $ && (T = 5), T === 8 ? /* @__PURE__ */ new Error("Input \"key_padding_mask\" shape shall be (batch_size) or (batch_size, total_sequence_length)") : /* @__PURE__ */ new Error("Mask not supported");
		}
		let I = !1, E = g;
		...
		let u = [
			...
			let g = R("qkv_with_bias", e.dataType, u), b = O("qkv", e.dataType, u), y = O("bias", r.dataType, u);
			return `
  ${m.registerUniforms([
				{
					name: "output_size",
...
var Ng, Vg, Ol, Lg, zl, Dl = V(() => {
	...
	Ng = (t, e) => {
		...
		if (r.dims.length !== 3 && r.dims.length !== 5) throw new Error("Input query is expected to have 3 or 5 dimensions");
		let d = r.dims[0], c = r.dims[1], p = r.dims.length === 3 ? r.dims[2] : e.numHeads * r.dims[4], m = c, g = 0, b = !n || n.dims.length === 0, y = Math.floor(b ? p / (e.numHeads + 2 * e.kvNumHeads) : p / e.numHeads);
		b && (p = y * e.numHeads);
		...
		let T = 0, I = !1, E = e.kvNumHeads ? y * e.kvNumHeads : p;
		...
		let o = 7, i = ["type", "type"], s = [t * e], u = t * e, d = [
			...
			let m = O("seq_lens", r.dataType, r.dims), g = O("total_seq_lens", n.dataType, n.dims), b = R("pos_ids", o, s);
			return `
  ${p.registerUniforms([
				{
					name: "output_size",
  ...
  ${S.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${T.setByOffset("global_idx", "value")};
		...
		let n = e[0].dims, o = n, i = n[0], s = n[n.length - 1], u = k.sizeFromDimension(n, 1) / s, d = fe(s), c = k.size(o) / d, p = [{
			...
			type: 12,
			data: Math.floor(s / d)
		}], m = ["type", "type"], g = !1, b = [0, n.length - 1];
		for (let x = 0; x < n.length - 2; x++) g = g || n[x + 1] !== 1, b.push(x + 1);
		g = g && n[n.length - 1] !== 1;
		let y = g ? t.compute(Oe(t.inputs[0], b), {
			inputs: [t.inputs[0]],
			outputs: [-1]
		})[0] : t.inputs[0].reshape(Array.from({ length: n.length }, (x, $) => n[b[$]])), w = Bl(t, y, e[1], e[2], i, u, s, r.epsilon), S = (x) => {
			let $ = be(e[0].dataType), T = d === 1 ? "vec2f" : `mat${d}x2f`, I = (z) => {
				let v = z === 0 ? "x" : "y", M = d === 1 ? "f32" : `vec${d}f`;
				switch (d) {
					case 1: return `${$}(${M}(scale.${v}))`;
					case 2: return `vec2<${$}>(${M}(scale[0].${v}, scale[1].${v}))`;
					case 4: return `vec4<${$}>(${M}(scale[0].${v}, scale[1].${v}, scale[2].${v}, scale[3].${v}))`;
...
var Kg, jg, Zg, Wl, Gl, Hl = V(() => {
	...
	Kg = (t, e) => {
		...
		let r = t[0].dims, n = r.length, o = r[n - 2], i = e.k, s = e.n, u = r.slice(0, n - 2), d = k.size(u), p = t[1].dims[2] / 4, m = t[0].dataType, g = fe(e.k), b = fe(p), y = fe(s), w = u.concat([o, s]), S = o > 1 && s / y % 2 === 0 ? 2 : 1, x = k.size(w) / y / S, $ = 64, T = [], I = [
			d,
			o,
			i / g
		...
		let r = t[0].dims, n = r.length, o = r[n - 2], i = e.k, s = e.n, u = r.slice(0, n - 2), d = k.size(u), p = t[1].dims[2] / 4, m = t[0].dataType, g = fe(e.k), b = fe(p), y = u.concat([o, s]), w = 128, S = s % 8 === 0 ? 8 : s % 4 === 0 ? 4 : 1, x = w / S, $ = x * b * 8, T = $ / g, I = $ / e.blockSize, E = k.size(y) / S, A = [], z = [
			d,
			o,
			i / g
...
var Qg, Yg, Xg, Jg, ey, ty, ry, ny, Fl, ql = V(() => {
	...
	Qg = (t) => {
      ...
      `;
		...
		switch (r.mode) {
			case 0: return Yg(t, e, r.pads.length);
			case 1: return Xg(t, e, r.pads.length);
			case 2: return Jg(t, e, r.pads.length);
			case 3: return ey(t, e, r.pads.length);
...
var cn, Kl, jl, Zl, Ql, oy, iy, Yl, Xl, Jl, ec, tc, rc, nc, oc, ic, ac, sc, uc, dc = V(() => {
	...
	cn = (t) => {
		...
		cn(t.inputs), t.compute(Xl("AveragePool", t.inputs[0], !1, e));
	}, tc = {
		autoPad: "",
		ceilMode: 0,
		countIncludePad: !1,
		...
		cn(t.inputs), t.compute(Xl("GlobalAveragePool", t.inputs[0], !0, e));
	}, oc = (t, e, r, n) => {
		let [o, i] = Kl(e, n, r), s = `
    ...
    `, u = "", d = O("x", e.dataType, e.dims.length), c = ["rank"], [p, m, g, b, y] = jl(i, o);
		...
		cn(t.inputs), t.compute(oc("MaxPool", t.inputs[0], !1, e));
	}, ac = (t) => {
		...
		cn(t.inputs), t.compute(oc("GlobalMaxPool", t.inputs[0], !0, e));
	};
});
var sy, uy, lc, cc, pc = V(() => {
	...
	sy = (t, e) => {
		...
		let r = k.normalizeAxis(e.axis, t[0].dims.length), n = t[0].dataType, o = n === 3, i = t[0].dims, s = t[1].dataType, u = k.size(i), d = n === 3 || n === 2, c = d ? [Math.ceil(k.size(t[0].dims) / 4)] : t[0].dims, p = t[1].dims, m = t.length > 2 ? t[2] : void 0, g = m ? d ? [Math.ceil(k.size(m.dims) / 4)] : m.dims : void 0, b = p.length === 0 || p.length === 1 && p[0] === 1, y = b === !1 && p.length === 1, w = fe(u), S = b && (!d || w === 4), x = S ? w : 1, $ = S && !d ? w : 1, T = O("input", d ? 12 : n, c.length, $), I = O("scale", s, p.length), E = m ? O("zero_point", d ? 12 : n, g.length) : void 0, A = R("output", s, i.length, x), z = [T, I];
		E && z.push(E);
		let v = [c, p];
		m && v.push(g);
		let M = [
...
` : "", Sy = (t, e, r, n, o) => {
    ...
    fn bilinearInterpolation(output_indices: ${e.type.indices}) -> ${p} {
      ...
      return (x11 * dx2 * dy2 + x12 * dx2 * dy1 + x21 * dx1 * dy2 + x22 * dx1 * dy1);
		...
		let [g, b] = r.length === 2 ? [0, 1] : [2, 3], y = t.type.value, w = (S) => {
			let x = S === g ? "row" : "col";
			return `
...
var Ey, ky, xc, Sc = V(() => {
	...
	Ey = (t) => {
      ...
      ${E.mainStart([
		...
		Ey(t.inputs);
		let n = [0];
		t.outputCount > 1 && n.push(-3), t.outputCount > 2 && n.push(-3), t.outputCount > 3 && n.push(3), t.compute(ky(t.inputs, e, t.outputCount, !1), { outputs: n });
	};
});
...
var By, My, Ec, kc, Pc = V(() => {
	...
	By = (t) => {
		...
		u ? (c = Array.from({ length: i }, (z, v) => v), c[s] = i - 1, c[i - 1] = s, d = t.compute(Oe(r, c), {
			inputs: [r],
			outputs: [-1]
		})[0]) : d = r;
...
var Rc, Uc = V(() => {
	...
	Rc = new Map([
		...
		["FusedConv", [Io, To]],
		["Gather", [dl, ul]],
		["GatherElements", [bl, yl]],
		["GatherBlockQuantized", [fl, hl]],
		["GatherND", [cl, pl]],
		["Gelu", [Lu]],
		["Gemm", [vl, _l]],
	...
	Fy = (t, e) => {
		...
		try {
			...
			if (g && !y) {
				...
				_t("wasm bindInputsOutputs"), Mt.set(t, [
					c,
					p,
					m,
					g,
			...
			g && !b && (s._OrtClearBoundOutputs(g.handle) !== 0 && me("Can't clear bound outputs."), Mt.set(t, [
				c,
				p,
				m,
				g,
...
var Rt, He, ur, hn, gn, fn, Ro, Uo, Ft, qt, jy, qc, Kc, jc, Zc, Qc, Yc, Xc, No = V(() => {
	...
	vt();
	Cr();
	Rt = () => !!ye.wasm.proxy && typeof document < "u", ur = !1, hn = !1, gn = !1, Uo = /* @__PURE__ */ new Map(), Ft = (t, e) => {
		let r = Uo.get(t);
		...
		switch (t.data.type) {
			case "init-wasm":
				ur = !1, t.data.err ? (gn = !0, Ro[1](t.data.err)) : (hn = !0, Ro[0]()), fn && (URL.revokeObjectURL(fn), fn = void 0);
				break;
			case "init-ep":
			case "copy-from":
			case "create":
		...
		if (!hn) {
			...
			if (ur = !0, Rt()) return new Promise((t, e) => {
			...
			try {
				await Ar(ye.wasm), await Er(ye), hn = !0;
			} catch (t) {
				throw gn = !0, t;
			} finally {
				ur = !1;
...
var rp = {};
Vt(rp, {
	OnnxruntimeWebAssemblyBackend: () => bn,
	initializeFlags: () => tp,
	wasmBackend: () => Qy
});
var tp, bn, Qy, np = V(() => {
...
*/
//#endregion
export { vf as InferenceSession, Sr as TRACE, wt as TRACE_EVENT_BEGIN, _t as TRACE_EVENT_END, Ne as TRACE_FUNC_BEGIN, Me as TRACE_FUNC_END, Ke as Tensor, sT as default, ye as env, kt as registerBackend };

//# sourceMappingURL=ort.bundle.min-BDhzGUGX.js.map